			...
			<div class="card-body">
				<div class="row text-center pt-4">
					<div class="col-lg-4 pb-4">
						...
						<h2>นายมูฮำมัดบะห์รี กาเดร์</h2>
						<p class="text-muted">รหัสประจำตัวนักศึกษา: 6139010021</p>
						<p class="pt-3"><a class="btn btn-primary" href="https://www.facebook.com/bahree.kadey.750?epa=SEARCH_BOX" role="button"><i class="fab fa-facebook-square"></i>&nbsp; @Muhammadbahree Kadey</a></p>
					</div>
					<div class="col-lg-4 pb-4">
						...
						<h2>นายอนุรักษ์ มะสะ</h2>
						<p class="text-muted">รหัสประจำตัวนักศึกษา: 6139010010</p>
						<p class="pt-3"><a class="btn btn-primary" href="https://www.facebook.com/profile.php?id=100009150577067" role="button"><i class="fab fa-facebook-square"></i>&nbsp; @Anurak Masa</a></p>
					</div>
					<div class="col-lg-4 pb-4">
